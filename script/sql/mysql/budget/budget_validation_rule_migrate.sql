-- ----------------------------
-- budget_validation_rule 表结构迁移
-- 旧表结构（budget.sql）：rule_category, risk_level, validation_scope, is_strict, rule_formula, rule_description
-- 新表结构（budget_validation_rule.sql）：rule_type, severity_level, subject_type, subject_code, threshold_value2, rule_expression, description
-- ----------------------------
